...
public class PlayerPrimaryAttackState : PlayerState
{
    ...
    public override void Enter()
    {
        ...
        // we adding a little velocity to player while he attacking but depends on attack style
    ...
    public override void Exit()
    {
        ...
        // normally here player.StartCoroutine("BusyFor" , .15f); but i didnt like it
